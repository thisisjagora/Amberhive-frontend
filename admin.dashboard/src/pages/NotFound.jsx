...
import { useNavigate } from "react-router"; // useNavigate instead of useHistor
    ...
    <div className="h-screen flex flex-col justify-center items-center text-center">
      <div className="space-y-4">
        ...
        <Button
          ...
          className="mt-6 px-6 py-2 bg-[#0A0451] text-white font-semibold rounded-lg hover:bg-[#0A0451] transition"
        >
          Go Back to Home
        </Button>
      </div>
