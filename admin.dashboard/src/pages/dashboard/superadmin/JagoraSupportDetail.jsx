...
import { fetchTicketById, replyTicket } from "@/redux/slices/ticketJagoraSlice";
import SuperAdminLayout from "./DashboardLayout";
import { closeTicket } from "@/redux/slices/supportTicketSlice";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function JagoraSupportDetail() {
  ...
  const { ticketDetail, statusTicketDetail, error, statusReplyTicket } =
    useSelector((state) => state.ticketJagora);

  const { statusCloseTicket } = useSelector((state) => state.supportTicket);
                    ...
                    {["open", "in_progress", "resolved"].includes(
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button
                            size="sm"
                            className="ml-2 bg-red-500 hover:bg-red-600 cursor-pointer text-white"
