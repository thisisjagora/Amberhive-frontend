...
const TicketDetail = () => {
  ...
  const handleBack = () => {
    if (location.state?.from === "ticket-tab") {
      navigate("/support?tab=allticket");
    } else {
      navigate(-1);
    }
  };
  ...
  const handleAcceptTicket = async () => {
    ...
    try {
      ...
      dispatch(fetchTicketById(id));
      toast.success(response?.message || "Ticket accepted successfully");
    } catch (error) {
      toast.error(error);
    }
  };
  ...
  return (
    ...
    >
      <div className="md:my-6 gap-6 md:mt-10">
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button
                          ...
                          disabled={statusAcceptTicket === "loading"}
                        >
                          {statusAcceptTicket === "loading"
                            ? "Processing..."
                            : "Accept Ticket"}
                        </Button>
                      </AlertDialogTrigger>
